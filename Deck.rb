...
card2 = {:id => 2, :name => "Pot of Greed", :type => "spell", :desc => "Draw 2 card from your deck", :effect => "2.times do draw('yes') end"}
...
card7 = {:id => 7, :name => "Monster Reborn", :type => "spell",:desc => "Special Summon 1 monster from either player's Graveyard to your side of the field.", :effect => "summon($graveyard)"}
...
2.times do draw('yes') end"}
card12 = {:id => 12, :name => "Compulsory Evacuation Device", :type => "spell", :desc => "Return 1 monster on the field to it's owner's hand.", :effect => "move($monsterfield)"} # Should be a trap card but is a temporarily a spell to allow testing.
