...
card2 = {:id => 2, :name => "Pot of Greed", :type => "spell", :desc => "Draw 2 card from your deck", :effect => "2.times do draw($activeplayer,'yes') end", :file => "Images/PotofGreed.jpg"}
...
card7 = {:id => 7, :name => "Monster Reborn", :type => "spell",:desc => "Special Summon 1 monster from either player's Graveyard to your side of the field.", :effect => "summon($graveyard1)", :file => "Images/MonsterReborn.jpg"}
...
2.times do draw($activeplayer,'yes') end", :file => "Images/HandDestruction.png"}
