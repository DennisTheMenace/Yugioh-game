...
if $version == 1.2	# Defines a different version of the card depending on the version of the game
...
card13 = {:id => 13, :name => "Fortune Lady Water", :type => "monster",:desc => "This card's ATK and DEF are equal to its Level x 300 . During each of your Standby Phases , increase the Level of this card by 1 (max 12) . When this card is Special Summoned while you control a face-up Fortune Lady' monster except 'Fortune Lady Water', draw 2 cards .", :atk => 1200, :def => 1200, :level => 4, :file => "Images/FortuneLadyWater.jpg", :effect => ""}
#Fortune Lady Water STATUS: semi-working INFO: Effect hasn't been implemented yet due to Routine method not finished

# Fortune Lady Water routine = '
#if phase == 'standbyphase'
#  increased = @@monsterfield[0][:atk] += 300 
#  card13 {:atk => increased}
#
#end
#'
